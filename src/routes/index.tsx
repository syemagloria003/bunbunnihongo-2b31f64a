    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="px-6 py-6 md:py-8 bg-muted/30 md:min-h-[calc(100vh-4rem)] md:flex md:items-start">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 md:grid-rows-[auto_auto_auto] gap-x-6 w-full">
          {/* Row 1: headings */}
          <h2 id="kelas" className="scroll-mt-20 text-xl md:text-2xl font-display font-bold mb-1">
            Kelas yang dibuka 📣
          </h2>
      ...
      <section id="sensei" className="px-6 py-6 md:py-8 bg-muted/20 scroll-mt-12 md:min-h-[calc(100vh-4rem)] md:flex md:items-start">
      ...
      {/* FAQ */}
      <section id="faq" className="px-6 py-8 md:py-12 scroll-mt-28 bg-gradient-to-b from-background to-primary/5">

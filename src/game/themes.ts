...
export const THEMES: Record<WorldTheme, ThemePalette> = {
  ...
  crystal_cave: {
    skyTop: "#0a1a3a", skyBottom: "#1a3a6a", light: "#9ee0ff",
    farBack: "#1a2848", farFront: "#243860",
    midAccent: "#7ac8ff", midAccent2: "#b889ff",
    foreground: "rgba(140, 200, 255, 0.35)",
    groundTop: "#3a4a6a", groundBottom: "#1a2440", groundDeco: "rgba(150,220,255,0.35)",
    cap: "", capDark: "",
    platformTop: "#7ac8ff", platformBottom: "#2a5a9a", platformBolt: "#cfeaff",
    coinCore: "#cff4ff", coinEdge: "#3aaadc", coinGlow: "rgba(120,220,255,0.6)",
    gateFrame: "#1a2848", gateInner: "rgba(150,220,255,0.55)", gateBorder: "#9ee0ff",
    goalA: "#9ee0ff", goalB: "#3a6abf", goalAccent: "#fff", goalFlag: "#b889ff",
    walkerA: "#2a1a3a", walkerB: "#0a0820", walkerAccent: "#ff4040",
    flyerBody: "#1a1828", flyerAccent: "#b889ff", flyerWing: "rgba(40,30,60,0.85)",
    particleCoin: "#9ee0ff", particleCoinSpark: "#ffffff",
    walkerBurst: "#5a2a8a", flyerBurst: "#3a2a5a",
    confetti: ["#9ee0ff", "#b889ff", "#ffffff", "#7ac8ff", "#3aaadc"],
    cloudColor: "rgba(140,180,220,0.35)",

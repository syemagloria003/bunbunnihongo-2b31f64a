...
export const THEMES: Record<WorldTheme, ThemePalette> = {
  ...
  crystal_cave: {
    ...
    farBack: "#1f2e54", farFront: "#2c4674",
    midAccent: "#7ad6ff", midAccent2: "#d09bff",
    foreground: "rgba(180, 230, 255, 0.5)",
    groundTop: "#3f527a", groundBottom: "#1a2440", groundDeco: "rgba(180,230,255,0.5)",
    cap: "#6fb8e8", capDark: "#3a6aa0",
    platformTop: "#9ae0ff", platformBottom: "#2a5a9a", platformBolt: "#ffffff",
    coinCore: "#e6fbff", coinEdge: "#4ec4ee", coinGlow: "rgba(150,235,255,0.85)",
    gateFrame: "#1a2848", gateInner: "rgba(170,235,255,0.7)", gateBorder: "#c5f0ff",
    goalA: "#b8ecff", goalB: "#3a6abf", goalAccent: "#ffffff", goalFlag: "#ff9ae0",
    walkerA: "#3a1a5a", walkerB: "#0a0820", walkerAccent: "#ff6a6a",
    flyerBody: "#1a1828", flyerAccent: "#d09bff", flyerWing: "rgba(170,210,255,0.55)",
    particleCoin: "#aef0ff", particleCoinSpark: "#ffffff",
    walkerBurst: "#7a3acf", flyerBurst: "#5a3a9a",
    confetti: ["#aef0ff", "#d09bff", "#ffffff", "#7ad6ff", "#ff9ae0", "#ffe070"],
    cloudColor: "rgba(170,210,255,0.4)",
